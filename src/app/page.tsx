      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-b from-white/50 to-[#FFFDF7]">
        ...
        >
          ...
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            ...
            <p className="text-sm sm:text-base text-[#2B2B2B]/60 max-w-xl mx-auto px-4">Join us for an unforgettable celebration</p>
          </div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-[#D4AF37]/20">
            ...
            <div className="p-5 sm:p-8 md:p-10 bg-gradient-to-b from-white to-[#FFFDF7]">
              <a
                ...
                className="block"
              >
                <Button className="w-full bg-gradient-to-r from-[#E6C47B] to-[#C9A34E] hover:from-[#D4AF37] hover:to-[#B8922E] active:from-[#D4AF37] active:to-[#B8922E] text-[#2B2B2B] py-5 sm:py-6 md:py-7 text-base sm:text-lg shadow-xl hover:shadow-2xl active:shadow-2xl transition-all duration-300 transform sm:hover:scale-[1.02]">
